    ...
    return (
        <div className="bg-gradient-to-l from-black to-gray-700 text-white flex mt-4">
            <div className="md:flex max-w-6xl mx-auto">
                <div className="py-8 md:py-16 p-8">
                ...
                <div className="max-w-6xl mx-auto w-9/12 pr-4 pb-16 md:py-24 text-opacity-50 items-center">
                    ...
                    <p className="pt-2 md:w-9/12 text-sm sm:text-base">One Plus Nord comes with Qualcomm Snapdragon 765G 5G Mobile Platform octa core processor, Adreno 620 GPU . With that comes 6.44-inch 90Hz fluid Amoled display with 2400 x 1080 pixels resolution | 408ppi.</p>
                    <Button
                        text="Buy Now"
                    />
                </div>
